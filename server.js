...
app.get("/terms", (req, res) => {
    res.send(`<!DOCTYPE html><html><head><title>AskScoobyAI — Terms of Use</title>
    <style>
        body{font-family:-apple-system,sans-serif;background:#0f1117;color:#e5e7eb;margin:0;padding:32px 20px;line-height:1.6;}
        .wrap{max-width:680px;margin:0 auto;}
        h1{color:#facc15;font-size:24px;margin-bottom:4px;}
        h2{color:#fff;font-size:16px;margin-top:32px;margin-bottom:10px;}
        p, li{color:#d1d5db;font-size:14px;}
        strong{color:#fff;}
        ul{padding-left:20px;}
        .updated{color:#9ca3af;font-size:12px;margin-top:40px;border-top:0.5px solid #374151;padding-top:16px;}
    </style></head>
    <body><div class="wrap">
        <h1>AskScoobyAI — Terms of Use</h1>

        <h2>1. Nature of the Service</h2>
        <p>AskScoobyAI is an AI-assisted interview preparation tool. It generates interview questions, sample answers, STAR-format responses, cover letters, CV suggestions, mock interview feedback, and coaching analysis based on content you provide (your CV, a job description, and your spoken practice answers) and third-party AI models.</p>
        <p><strong>AskScoobyAI is a preparation aid, not a guarantee of interview or job application success.</strong> It does not constitute career, legal, HR, recruitment, or professional advice of any kind.</p>

        <h2>2. Your Responsibility for Input Content</h2>
        <p>You are solely responsible for the content you provide, including your CV and any job description you paste or import.</p>
        <ul>
            <li>You confirm that any CV, personal information, or job description you submit is accurate, lawfully obtained, and either your own or content you have the right to use.</li>
            <li><strong>Output quality depends entirely on input quality and relevance.</strong> If your CV is not relevant to, or does not reasonably match, the job description provided, the generated materials may be inaccurate, generic, or unhelpful.</li>
            <li>We do not verify the accuracy of any CV or job description you submit, and we are not responsible for any consequences arising from inaccurate, outdated, or misrepresented information you provide.</li>
        </ul>

        <h2>3. AI-Generated Content — No Warranty of Accuracy</h2>
        <p>All interview questions, sample answers, STAR responses, cover letters, CV suggestions, mock interview feedback, and Scooby Coach analyses are generated by third-party large language models (currently including Anthropic's Claude models). This content:</p>
        <ul>
            <li><strong>May contain errors, inaccuracies, generic content, or statements that do not reflect your actual experience, skills, or circumstances.</strong></li>
            <li>Is provided "as is" and "as available," without warranties of any kind, express or implied.</li>
            <li>Should be reviewed, verified, and adapted by you before use in any real interview, job application, or professional context.</li>
            <li>Does not represent the views, advice, or endorsement of AskScoobyAI, and is not reviewed by a human before being shown to you.</li>
        </ul>
        <p><strong>We are not liable for any outcome — including a failed interview, rejected application, or any other consequence — arising from your use of, or reliance on, AI-generated content.</strong></p>

        <h2>4. Voice Transcription — Accuracy Limitations</h2>
        <p>The AI Mock Interview feature uses your browser's built-in speech recognition (Chrome's Web Speech API) to transcribe your spoken answers in real time.</p>
        <ul>
            <li><strong>This transcription is provided by a third party and is not guaranteed to be accurate.</strong> Technical terms, product names, acronyms, accents, and background noise can all cause words to be misheard or transcribed incorrectly.</li>
            <li>Feedback and scoring generated from your practice session is based on this transcript, not a verified recording of what you actually said.</li>
